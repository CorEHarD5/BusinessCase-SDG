...
resource "snowflake_view" "VW_HR_DEV_M_EYES" {
...
FROM BD_HR_DEV.SC_HR_DEV_M.TB_HR_DEV_HEROES_M
...
resource "snowflake_view" "VW_HR_DEV_F_EYES" {
depends_on = [ snowflake_database.BD_HR_DEV, snowflake_schema.SC_HR_DEV_F, snowflake_table.TB_HR_DEV_HEROES_F]
  database = snowflake_database.BD_HR_DEV.name
  ...
  statement  = <<-SQL
    SELECT "Name", "Identity", "Publisher", "EyeColor"
FROM BD_HR_DEV.SC_HR_DEV_F.TB_HR_DEV_HEROES_F
WHERE "Publisher" = 'Marvel Comics' AND "EyeColor" = 'Blue';
SQL
  or_replace = true
}
...
resource "snowflake_view" "VW_HR_DEV_M_DC" {
  database = snowflake_database.BD_HR_DEV.name
  schema   = snowflake_schema.SC_HR_DEV_M.name
  name     = "view_male_dc"
...
resource "snowflake_view" "VW_HR_DEV_F_DC" {
depends_on = [ snowflake_database.BD_HR_DEV, snowflake_schema.SC_HR_DEV_F, snowflake_table.TB_HR_DEV_HEROES_F]
  database = snowflake_database.BD_HR_DEV.name
  schema   = snowflake_schema.SC_HR_DEV_F.name
  name     = "view_female_dc"
...
resource "snowflake_view" "VW_HR_DEV_M_HAIR" {
  database = snowflake_database.BD_HR_DEV.name
  schema   = snowflake_schema.SC_HR_DEV_M.name
...
resource "snowflake_view" "VW_HR_DEV_F_HAIR" {
depends_on = [ snowflake_database.BD_HR_DEV, snowflake_schema.SC_HR_DEV_F, snowflake_table.TB_HR_DEV_HEROES_F]
  database = snowflake_database.BD_HR_DEV.name
  schema   = snowflake_schema.SC_HR_DEV_F.name
